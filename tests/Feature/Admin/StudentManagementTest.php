...
it('ينشئ طالبًا جديدًا بنجاح', function () {
    ...
    $response = $this->actingAs($user)->post(route('admin.students.store'), [
        ...
        'identity_expiry_date' => '2030-05-01',
        'gender' => 'male',
        'phone' => '0501234567',
        'whatsapp' => '0501234567',
        'status' => 'active',
...
it('يرفض إنشاء طالب بدون كود الطالب أو رقم الهوية أو تاريخ انتهائها', function () {
    $user = makeStudentManager();
    $branch = Branch::factory()->create();
    ...
    $response
        ...
        ->assertSessionHasErrors(['student_code', 'identity_number', 'identity_expiry_date']);
});
