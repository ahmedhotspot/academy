...
@section('title', 'إدارة خطط الرسوم — تعديل الخطة')
    ...
    <div class="page-content-wrapper">
        <div class="content-container">
            <div class="page-content">
                ...
                <form action="{{ route('admin.fee-plans.update', $feePlan) }}"
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-white border-bottom d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h6 class="mb-0 fw-semibold">تعديل بيانات الخطة</h6>
                            </div>
                        ...
                        <div class="card-footer bg-white border-top d-flex gap-2 justify-content-end">
                            <a href="{{ route('admin.fee-plans.show', $feePlan) }}"
                               class="btn btn-light">
