...
<div class="page-content-wrapper">
    <div class="content-container">
        <div class="page-content">
            ...
            <form action="{{ route('admin.students.store') }}" method="POST" id="student-form" novalidate>
                @csrf
                <div class="form-card">
                    <div class="form-card-header">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h5 class="mb-0 fw-bold">تسجيل طالب جديد في أكاديمية تحفيظ القرآن الكريم</h5>
                                <p class="mb-0 small" style="opacity:.8;">أدخل بيانات الطالب بشكل صحيح ودقيق</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-footer bg-white border-top p-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
                        ...
                        <div class="d-flex gap-2">
                            <button type="reset" class="btn btn-outline-secondary">
                                <i class="ti ti-rotate me-1"></i>مسح البيانات
                            </button>
                            <button type="submit" class="btn btn-success px-4" id="submit-btn">
                                <i class="ti ti-device-floppy me-1"></i>حفظ الطالب
                            </button>
                        </div>
                    </div>
                </div>
