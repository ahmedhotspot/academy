...
<head>
    ...
    <style>
        ...
        .password-toggle:hover { color: #1a4731; }
        .portal-label { background: linear-gradient(135deg,#1a4731,#2d7a4f); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
    </style>
</head>
<body>
<div class="m-0 authentication-inner row">
    ...
    <div class="p-4 d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5">
        <form class="form w-100" method="POST" action="{{ route('student.login') }}">
            @csrf
            <div class="mx-auto w-px-200">
                <div class="mb-3 text-center">
                    <div class="bg-success-subtle rounded-circle d-inline-flex align-items-center justify-content-center mb-3" style="width:64px;height:64px;">
                        <i class="ti ti-user-graduate" style="font-size:2rem;color:#1a4731;"></i>
                    </div>
                    <h4 class="fw-bold mb-1 portal-label">بوابة الطالب</h4>
