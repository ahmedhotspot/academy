...
<head>
    ...
    <title>@yield('title', 'بوابة الطالب - أكاديمية القرآن')</title>
    ...
    <style>
        ...
        .portal-navbar { background: linear-gradient(135deg, #1a4731 0%, #2d7a4f 100%); }
...
<nav class="navbar navbar-expand-lg portal-navbar px-4 py-2 shadow-sm">
    <a class="navbar-brand fw-bold" href="{{ route('student.dashboard') }}">
        <i class="ti ti-book-2 me-2"></i>بوابة الطالب
    </a>
    <div class="ms-auto d-flex align-items-center gap-3">
        <span class="portal-badge"><i class="ti ti-user-graduate me-1"></i>{{ auth('student')->user()?->full_name }}</span>
